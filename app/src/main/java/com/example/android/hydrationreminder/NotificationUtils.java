...
public class NotificationUtils {
   private static final int WATER_REMINDER_PENDING_INENT_ID = 12;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1223;
    private static final int ACTION_IGNORE_PENDING_INTENT = 324;
    private static final int ACTION_DRINK_PENDING_INTENT = 325;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent ignoreIntent = PendingIntent.getService(context,ACTION_IGNORE_PENDING_INTENT,intent,PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action ignoreAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"Dismiss ! ",ignoreIntent);
        return ignoreAction;
    }
    private static NotificationCompat.Action drinkAction(Context context){
        ...
        PendingIntent drinkIntent = PendingIntent.getService(context,ACTION_DRINK_PENDING_INTENT,intent,PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action drinkAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"Drinko ! ",drinkIntent);
        return drinkAction;
    }
    ...
    // the notification is pressed. This pending intent should open up the MainActivity.
     private static PendingIntent contentIntent(Context context){
         ...
         return PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INENT_ID,intent,PendingIntent.FLAG_UPDATE_CURRENT);
     }
